        ...
        <form>
          <div className="row">
            <div className="col one-half">
              ...
              <input type="text" name="character" value={ null/* TODO */ } onChange={ null/* TODO */} />
            </div>
            <div className="col one-half">
              <label forHtml="family">Familia</label>
              <select name="family" value={ null/* TODO */ } onChange={ null/* TODO */} >
          ...
          <div className="row">
            <div className="col one-half">
              ...
              <input type="checkbox" name="alive" checked={ null/* TODO */ } onChange={ null/* TODO */ }  />
            </div>
            <div className="col one-half">
              <fieldset>
