        ...
        <div className="checkout-form">
          ...
          <div className="row">
            <div className="col one-whole">
              <button ref='cancelButton' className="button" onClick={this.goBackToCart}>Volver al carrito</button>
              <button ref='saveButton' className="button" onClick={this.handleSubmit}>Finalizar</button>
            </div>
          </div>
        </div>
    </div>
