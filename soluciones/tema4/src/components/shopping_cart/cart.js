  ...
  render: function(){
    ...
    return (
      ...
      <div className="footer">
        <a className="button" href="/" onClick={this.gotoCatalog}>Seguir comprando</a>
        { itemCount ? <a className="button" href="/checkout" onClick={this.gotoCheckout}>Finalizar compra</a> : null }
      </div>
    </div>
    );
  }
